...
public class TicketManagerTest {
    ...
    Ticket ticket1 = new Ticket(1, 1_299, "VKO", "KZN", 95);
    Ticket ticket2 = new Ticket(2, 2_199, "VKO", "KZN", 95);
    Ticket ticket3 = new Ticket(3, 9_249, "LED", "IKT", 360);
    Ticket ticket4 = new Ticket(4, 11_494, "IKT", "LED", 400);
    Ticket ticket5 = new Ticket(5, 2_432, "LED", "KGD", 110);
    Ticket ticket6 = new Ticket(6, 4_843, "LED", "KGD", 115);
    Ticket ticket7 = new Ticket(7, 29_020, "LED", "IST", 230);
    Ticket ticket8 = new Ticket(8, 2_346, "LED", "KGD", 110);
